...
export enum BusinessProfileActionType {
  ...
  DELETE_PROFILE_REQUEST = '[Business Profile] Delete profile request',
  DELETE_PROFILE_SUCCESS = '[Business Profile] Delete profile success',
  DELETE_PROFILE_FAILURE = '[Business Profile] Delete profile failure',
}
...
export const deleteBusinessProfileRequest = createAction(
    BusinessProfileActionType.DELETE_PROFILE_REQUEST,
    props<{ businessProfileId: string }>(),
);

export const deleteBusinessProfileSuccess = createAction(
    BusinessProfileActionType.DELETE_PROFILE_SUCCESS,
    props<{ businessProfileId: string }>(),
);

export const deleteBusinessProfileFailure = createAction(
    BusinessProfileActionType.DELETE_PROFILE_FAILURE,
